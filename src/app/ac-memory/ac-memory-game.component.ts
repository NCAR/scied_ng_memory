...
@Component({
  selector: 'scied-ac-memory-game',
  templateUrl: './ac-memory-game.component.html',
  styleUrls: ['./ac-memory-game.component.scss']
})
export class AcMemoryGameComponent implements OnInit, OnDestroy {
  data: any = null;
  level: string = null;
