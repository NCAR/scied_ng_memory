...
@Component({
  selector: 'scied-eclipse-memory-game',
  templateUrl: './eclipse-memory-game.component.html',
  styleUrls: ['./eclipse-memory-game.component.scss']
})
export class EclipseMemoryGameComponent implements OnInit, OnDestroy {
  data: any = null;
  level: string = null;
